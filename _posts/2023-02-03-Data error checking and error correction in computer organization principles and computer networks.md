...
| 1.最小码距≥e+1     可检测e个错误   2.最小码距≥2t+1    可纠正t个错误   3.最小码距≥e+t+1e>t    可纠正t个错误，同时检测e个错误                       <font color = red>且表示假设无更多位错误发生时，可以区分这两种出错模式，或表示无法区分，需要进一步假设</font> | ![image-20230206113341636](https://wendaocsmaster.github.io/images/blog/image-20230206113341636.png) |
| ------------------------------------------------------------ | :----------------------------------------------------------- |
...
| G1(P1,H3,H5,H7)     G2(P2,H3,H6,H7) G3(P3,H5,H6,H7) | ![image-20230206124034274](https://wendaocsmaster.github.io/images/blog/image-20230206124034274.png) |
| --------------------------------------------------- | ------------------------------------------------------------ |

于是得到如下数据位$$D_i$$校验位$$P_i$$是映射关系

| G1=P1⊕D1⊕D2⊕D4              G2=P2⊕D1⊕D3⊕D4 G3=P3⊕D2⊕D3⊕D4 | ![image-20230206125730650](https://wendaocsmaster.github.io/images/blog/image-20230206125730650.png) |
| --------------------------------------------------------- | ------------------------------------------------------------ |
