...
![img](https://wendaocsmaster.github.io/images/blog/4-1-16774090982401.png)
...
![此处输入图片的描述](https://wendaocsmaster.github.io/images/blog/document-uid18510labid59timestamp1482919171956.png)
...
![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200303-1583207588297.png)

我们可以在首选项里面切换到其他字体，可以看到该字体的波浪号默认是中间的。当然，这个并不影响我们操作。

![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200303-1583207655389.png)
...
![4-2.2-1](https://wendaocsmaster.github.io/images/blog/document-uid735639labid59timestamp1531733883613.png)
...
![4-2.2-2](https://wendaocsmaster.github.io/images/blog/document-uid735639labid59timestamp1531733900438.png)
...
![4-3.1-1](https://wendaocsmaster.github.io/images/blog/document-uid735639labid59timestamp1531733939312.png)

还有一点需要注意的是，若当前目录已经创建了一个 test 文件，再使用 `mkdir test` 新建同名的文件夹，系统会报错文件已存在。这符合 Linux 一切皆文件的理念。

![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200303-1583209669773.png)

若当前目录存在一个 test 文件夹，则 `touch` 命令，则会更改该文件夹的时间戳而不是新建文件。

![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200303-1583210207550.png)
...
![4-3.1-2](https://wendaocsmaster.github.io/images/blog/document-uid735639labid59timestamp1531733966731.png)
...
![4-3.3-1](https://wendaocsmaster.github.io/images/blog/document-uid735639labid59timestamp1531733991692.png)
...
![4-3.4-1](https://wendaocsmaster.github.io/images/blog/document-uid735639labid59timestamp1531734147663.png)
...
![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200303-1583213792916.png)
...
![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200303-1583213884277.png)
...
![4-3.4-1](https://wendaocsmaster.github.io/images/blog/document-uid735639labid59timestamp1531734168883.png)
...
![4-3.5-2](https://wendaocsmaster.github.io/images/blog/document-uid735639labid59timestamp1531734186668.png)
...
![4-3.5-3](https://wendaocsmaster.github.io/images/blog/document-uid735639labid59timestamp1531734202525.png)
...
![4-3.5-4](https://wendaocsmaster.github.io/images/blog/document-uid735639labid59timestamp1531734226305.png)
...
![4-3.6-1](https://wendaocsmaster.github.io/images/blog/document-uid735639labid59timestamp1531734243413.png)
...
![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200303-1583215158345.png)
