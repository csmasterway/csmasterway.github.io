...
![3-2.1-1](https://wendaocsmaster.github.io/images/blog/document-uid735639labid3timestamp1531731170296.png)
...
![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200302-1583140204433.png)
...
![3-2.2-1](https://wendaocsmaster.github.io/images/blog/document-uid735639labid3timestamp1531731216215.png)
...
![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200302-1583141675216.png)
...
![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200302-1583142076115.png)

你发现了区别了吗？这就是上一小节我们讲到的 `who am i` 和 `whoami` 命令的区别。

退出当前用户跟退出终端一样，可以使用 `exit` 命令或者使用快捷键 `Ctrl+D`。

![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200302-1583142261959.png)
...
![此处输入图片的描述](https://wendaocsmaster.github.io/images/blog/document-uid13labid3timestamp1454035714557.jpeg)
...
![此处输入图片的描述](https://wendaocsmaster.github.io/images/blog/document-uid13labid3timestamp1454035855554.jpeg)
...
![3-2.3-3](https://wendaocsmaster.github.io/images/blog/document-uid735639labid3timestamp1531731335264.png)
...
![此处输入图片的描述](https://wendaocsmaster.github.io/images/blog/document-uid13labid3timestamp1454035698068.jpeg)
...
![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200302-1583145040679.png)
...
![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200302-1583145514469.png)

然后你再切换回 lilei 用户，现在就可以使用 sudo 获取 root 权限了。

![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200302-1583145591124.png)
...
![3-2.4-1](https://wendaocsmaster.github.io/images/blog/document-uid735639labid3timestamp1531731417990.png)

使用 `--remove-home` 参数在删除用户时候会一并将该用户的工作目录一并删除。如果不使用那么系统会自动在 /home 目录为该用户保留工作目录。

![图片描述](https://wendaocsmaster.github.io/images/blog/uid871732-20200302-1583146790310.png)
